...
class LogicParser:
    ...
    def findTarget(self, phrase):
        ...
        if phrase[0] == "Minus":
            return ['Minus',self.findTarget(['Find', phrase[1]]),self.findTarget(['Find', phrase[2]])]
        if phrase[0] == "Add":
            return ['Add',self.findTarget(['Find', phrase[1]]),self.findTarget(['Find', phrase[2]])]
